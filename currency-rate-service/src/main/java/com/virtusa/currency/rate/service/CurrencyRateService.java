...
public class CurrencyRateService {
	...
	private Logger LOGGER = LoggerFactory.getLogger(CurrencyRateService.class);
	...
	{ 
	 ...
	 private CurrencyRateEntity saveRatesFromApi(String code, CurrencyEnum base, CurrencyEnum target) {
			  ...
			  LOGGER.info("Currency details not available in DB, Getting the currency details from third pary api input details :"+url);
